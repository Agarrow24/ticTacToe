...
const currentPlayerTurn = () => `It's ${joueurCourant}'s turn`; // Affichage du tableau
...
function isAlign(plate, x, y) {
  ...
  checkSet.clear(); // possible vertical alignments
  ...
  checkSet.clear(); // possible diagonal alignments
...
console.log(currentPlayerTurn); // ____________________________
